...
print >> phrase_file, '# %s phrase file generated by %s' % (prefix, sys.argv[
                                                            0])
...
for line in source_file:
    ...
    if count == 0:
        ...
        if not options.precise:
            print >> phrase_file, (u'# no possible interpretations for %s' % phrase).encode(
                'utf-8')
    elif count > 1:
        print >> phrase_file, (u'# %d possible interpretations for %s' % (
            count, phrase)).encode('utf-8')
